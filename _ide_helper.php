...
namespace {
    ...
    class HFile extends \App\Facades\FileFacades{
         ...
         * @static 
         */
        public static function getFileList($dir = 'repo', $list = array()){
            return \App\Services\File::getFileList($dir, $list);
        }
        ...
        public static function getFileInfo($filename){
            return \App\Services\File::getFileInfo($filename);
        }
